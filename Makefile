# Makefile for Agua de Florida Plugin Server Management
...
help: ## Show this help message
	@echo "🧪 Agua de Florida Plugin - Development Commands"
	@echo ""
...
test-commands: build install ## Build, install and show test commands
	...
	@echo "  /aguadeflorida give [player] [amount]  - Give Agua de Florida item"
	@echo "  /aguadeflorida help                    - Show command help"
	@echo ""
	@echo "=== Admin Commands (op required) ==="
	@echo "  /aguadeflorida reload                  - Reload plugin configuration"
	@echo ""
	@echo "=== Natural Testing ==="
	@echo "  Get Agua de Florida item and trigger death to test protection"
	@echo "  Kill configured mobs (Witch, Evoker) to test drops"
	@echo ""
...
release: validate build ## Create a release build
	...
	@mkdir -p releases
	@cp target/agua-de-florida-*.jar releases/
	@echo "✅ Release created in releases/ directory"

# Give Agua de Florida item for testing
give-agua: ## Give Agua de Florida item to test protection
	@echo "Creating Agua de Florida give command..."
	@echo "Run this in game: /aguadeflorida give @p 1"
	@echo "Or use the crafting recipe if enabled in config"
